...
**Phase 2 bis = CURRENT** — **2bis-A CLOSED / APPROVED** ; checkpoint actif : **2bis-B**, POM, fixtures, tagging et conventions exécutables uniquement. **Phase 3 = NOT STARTED**. Aucun 2bis-C sans validation explicite de Patrick.
