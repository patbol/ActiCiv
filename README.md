...
**Phase 2 bis = CURRENT** — checkpoint actif : **2bis-A**, baseline documentaire, Rules et gouvernance uniquement. **Phase 3 = NOT STARTED**. Aucun checkpoint suivant sans validation explicite de Patrick.
