...
`pnpm docs:generate` actualise la vue dérivée ; `pnpm docs:validate` contrôle le contrat. Une seule matrice de liens, sans duplication manuelle. 2bis-A à H sont approuvés ; I2 est en cours et Phase 3 non commencée.

## Checkpoint courant I2

A–H approuvés ; corrections ciblées I2 uniquement. Aucune I3 ni Phase 3. [Quality Center](technical/quality-center.md).
