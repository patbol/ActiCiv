...
Conséquences : les cas anonymes et les tâches de plateforme nécessiteront une conception explicite avant leur phase. Les clés élevées ne seront pas utilisées pour simplifier la démo. PostGIS reste une option à confirmer en phase 2. Aucun choix implicite sur le propriétaire des signalements hors couverture, les transferts ou les chevauchements.
