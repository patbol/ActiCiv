...
| [ADR-014](014-knowledge-skills-governance.md)   | Acceptée, active | Complète 008/011 sans supersession                           | Complément G : validation KB/Skills et traçabilité dérivée     |

| [ADR-015](015-quality-center.md) | Acceptée, active | Complète 011/012/014 sans supersession | Lecture canonique, capacité plateforme et UI read-only |
...
Patrick a approuvé A–H et ADR-008 à ADR-015. I2 complète les mécanismes prévus sans nouvelle architecture ni nouvelle ADR ; les propositions initiales et décisions ultérieures restent conservées.
